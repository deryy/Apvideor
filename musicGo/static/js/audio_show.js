...
function audio_show(){   
    ...
    ! function() {
        ! function() {
            var n = function(t) {
                function e(e, a, c) {
                    if (y.audio = null != t ? t : new Audio, i = null != e ? e : 32, u = null != a ? a : .1, s = null != c ? c : !1, "string" == typeof y.audio) {
                        var p = y.audio;
                        y.audio = new Audio, y.audio.crossOrigin = "anonymous", y.audio.controls = !0, y.audio.src = p
                    }
                    r = new n.AudioContext, d = r.createScriptProcessor(1024, 1, 1), l = r.createAnalyser(), l.smoothingTimeConstant = u, l.fftSize = 2 * i, f = !1, y.bands = new Uint8Array(l.frequencyBinCount), y.audio.addEventListener("play", o, !1)
                }

                function o() {
                    f || (c = r.createMediaElementSource(y.audio), c.connect(l), l.connect(d), d.connect(r.destination), s || c.connect(r.destination), d.onaudioprocess = a, f = !0)
                }
            ...
            }, n.AudioContext = window.AudioContext || window.webkitAudioContext, n.enabled = null != n.AudioContext, window.AudioAnalyser = n
        }(),
        function() {
            window.Analyser = function(n) {
                ...
                this.init = function(a, i) {
                    var u;
                    u = n ? n : "http://s1.dfntn.eu:8000/broadcast", r.numOfBands = null != a ? a : 32, r.smoothing = null != i ? i : .3, o = new AudioAnalyser(u, r.numOfBands, r.smoothing), o.onUpdate = function(n, o, a) {
    ...
    /**
     * The sketch,include the color of canvas use the form of hsb
     */
    (function() {
        var canvas = document.getElementById('canvas'),
            ...
            settings = {
                ...
                // brightness: 16.9,
                backgroundHue:223,
                backgroundSaturation: 27.9,
                backgroundBrightness: 16.9,
        ...
        function draw() {
            ...
            ctx.fillStyle = 'hsla(' + settings.backgroundHue + ',' + settings.backgroundSaturation + '%,' + settings.backgroundBrightness + '%, ' + settings.backgroundAlpha + ')';
